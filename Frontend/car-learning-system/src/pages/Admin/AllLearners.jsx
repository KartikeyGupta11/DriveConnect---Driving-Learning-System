...
const AllInstructors = () => {
  ...
  useEffect(() => {
    const fetchLearners = async () => {
      try {
        const res = await axios.get(`${import.meta.env.VITE_API_URL}/learners`);
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 p-6 bg-gray-100">
        ...
        {loading ? (
          <p className="text-center text-lg text-gray-600">Loading learners...</p>
        ) : learners.length === 0 ? (
          <p className="text-center text-gray-600">No learners found.</p>
        ) : (
              ...
              >
                <div className="flex items-center gap-4 border border-black p-2 rounded-2xl shadow-sm">
                  ...
                  <div className="flex-1">
                    ...
                    <h2 className="text-sm text-gray-500">{learner.email}</h2>
                  </div>
          ...
          >
            ...
            >
              <div className="flex justify-center items-center space-x-4">
                {/* <img
                  src={
                    selectedLearner.profilePic
                      ? `${IMAGE_BASE_URL}${selectedLearner.profilePic}`
                      : "https://via.placeholder.com/100"
                    }
